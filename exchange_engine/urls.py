...
urlpatterns = [
    ...
    path('API/profile/editing/', login_required(views.ProfileEditingView.as_view()), name='profile_editing'),
    path('API/profile/editing/change_password/', login_required(views.PasswordEditingView.as_view()), name='change_password'),
