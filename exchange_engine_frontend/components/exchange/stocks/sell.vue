        ...
        <v-row>
              ...
              <v-card-text class="pl-4 pr-4 pt-2 pb-2">
                <v-row no-gutters>
                  ...
                  <v-col class="d-flex align-center justify-end">
                    <p class="text-body-2 text-sm-subtitle-1 ma-0">
                      {{ stocks_portfolio.count }} шт.
                    </p>
                  </v-col>
                </v-row>
              </v-card-text>
          ...
          <v-col :cols="12">
            ...
            <v-form v-if="select == 1">
              <v-text-field v-model="price" min="0" append-icon="₮" outlined label="Цена" />
              <v-text-field v-model="amount" type="number" min="1" outlined label="Колическво" />
            </v-form>
